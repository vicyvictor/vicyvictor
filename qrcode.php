...
//text to output
$text = "NAME: ".$_SESSION['fname']." COURSE: ".$_SESSION['course'].",   REG. NO.:".$_SESSION['reg'].", LEVEL: ".$_SESSION['level'].", COURSES: ".$row['cC1'].", ".$row['cC2'].", ".$row['cC3'].", ".$row['cC4'].", ".$row['cC5'].", ".$row['cC6'].", ".$row['cC7'].", ".$row['cC8'].", ".$row['cC9'].", ".$row['cC10'];
...
<body>
    <div class="container">
        ...
        <div class="row" style="font-family:serif; font-weight: 600;">
            ...
            <h4>COURSE: BSc. <?php if(isset($_SESSION['course'])){ echo $_SESSION['course'];}; ?></h4>
            <h4>SESSION: 2023/2024
            <h4>REG.NO:<?php if(isset($_SESSION['reg'])){ echo $_SESSION['reg'];}; ?></h4> 
            <h4>YEAR: <?php if(isset($_SESSION['level'])){ echo $_SESSION['level'];}; ?></h4>
        ...
        <div class="row course" style="font-family:serif; font-weight: 600;">
            ...
            <h4 class="col-md-4" style="border: 1px solid black;">Invigilators Sign</h4>
        </div>
    <?php
